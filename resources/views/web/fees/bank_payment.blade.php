   ...
   <div class="row middle-hight">
      <div class="col-12">
         ...
         <div class="table-responsive  ">
            <table id="feesBankPaymentTable" class="table table-striped table-hover table-bordered">
                      ...
                      <td>2.54
                        ...
                        <td><a href=" " class=" w-100 text-uppercase font-12
                            ...
                            <td>
                                ...
                                data-bs-toggle="modal" data-bs-target="#bankPaymentDelete">DELETE</button>
                             <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="bankPaymentDelete"

...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">CLASS FEES - POS
         </h1>
   ...
   <div class="row middle-hight">
      <div class="col-12">
         ...
         <div class="table-responsive  ">
            <table id="feesPosTable" class="table table-striped table-hover table-bordered">
                      ...
                      <td>2.54
                        ...
                        <td><a href=" " class=" w-100 text-uppercase font-12
                            ...
                            <td>
                                ...
                                data-bs-toggle="modal" data-bs-target="#posDelete">DELETE</button>
                             <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="posDelete"

...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">PENDING ORDERS (DELIVERY)
         </h1>
         ITEM SHOP
      </div>
   ...
   <div class="row middle-hight">
      <div class="col-12">
         <div class="table-responsive  ">
            <table id="pendingOrderDeliver" class="table table-striped table-hover table-bordered">
